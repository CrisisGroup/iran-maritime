    ...
    chapters: [
      {
        ...
        },
        {
            ...
            title: 'Commercial tanker interception',
            image: '',
            description: '“We will make the enemy understand that either everyone can use the Strait of Hormuz or no one”, said the commander of the Islamic Revolutionary Guard Corps (IRGC) in July 2018.',
            location: {
              center: [12.234568, 23.422547],
              zoom: 2,
              pitch: 0,
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: 'President Hassan Rouhani likewise warned that “America should know that we are selling our oil and will continue to sell our oil and they are not able to stop our oil exports… if tone day they want to prevent the export of Iran’s oil then no oil will be exported from the Persian Gulf”.',
            location: {
              center: [12.234568, 23.422547],
              zoom: 2,
              pitch: 0,
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: 'In 12 May 2019, amidst high tension between Tehran and Washington, four tankers were attacked of the UAE port of Fujairah.',
            location: {
              center: [12.234568, 23.422547],
              zoom: 2,
              pitch: 0,
        ...
        },
        {
            ...
            title: 'Commercial tanker interception',
            image: '',
            description: 'In response, the U.S. announced it was putting together an International Maritime Security Construct to promote freedom of navigation. Eight countries are currently part of the Bahrain-based IMSC, which operates Task Force Sentinel. ',
            location: {
              center: [12.234568, 23.422547],
              zoom: 2,
              pitch: 0,
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: 'In January 2020, several European governments set up a parallel mission, European Maritime Awareness in the Strait of Hormuz (EMASOH), headquartered in Abu Dhabi.',
            location: {
              center: [12.234568, 23.422547],
              zoom: 2,
              pitch: 0,
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: 'A July 2021 attack against the Mercer Street, a Liberian-flagged, Japanese-owned vessel linked to Israeli ownership, was a notable escalation. It was deadly, killing the ship’s Romanian master and a UK citizen. And it was widely attributed to Iran, including by the G-7 and EU.',
            location: {
              center: [12.234568, 23.422547],
              zoom: 2,
              pitch: 0,
